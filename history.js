(function(){
  ...
  function setOpen(open){widget.classList.toggle("is-open",open);launch.setAttribute("aria-expanded",String(open));panel.setAttribute("aria-hidden",String(!open));if(open){document.dispatchEvent(new CustomEvent("winco-popup-open",{detail:"history"}));render();setTimeout(function(){search.focus()},30)}}
